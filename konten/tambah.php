...
<div class="content-wrapper">
    ...
    <div
        ...
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">  <!--lg = laugh(?) xl jg nyesuaiin ukuran di alertan  -->
            ...
            ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info btn-sm" type="submit" class="fas fa-check">Pilih</button> 
                                </form>
                            </td>
                        </tr>
                        <?php } ?> 
    ...
    <div
        ...
        aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">  <!--lg = laugh(?) xl jg nyesuaiin ukuran di alertan  -->
            <div class="modal-content">
                <div class="modal-header">
